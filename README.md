...
Hogia Hemekonomi är ett 16-bitars windowsprogram som visserligen fungerar i Windows 10 om man kör 32-bitars varianten och slår på 16-bitars funktionen. Men Windows 10 är i stort sett nedlagt. I Windows 11 krävs https://github.com/otya128/winevdm som inte ingår i operativsystemet.
...
Gränssnittet är lokalt webbaserat, dvs programmet körs i bakgrunden och användare interagerar via webläsaren. Allt körs lokalt på egna maskinen.

Detta programmet går att köra i Windows så länge det går att köra 32-bitars program dvs Windows 11 fungerar.
...
2. Och ett mer framtidssäkert filformat (Sqlite3) som fungerar på andra OS. Det ska gå att konvertera mellan båda med verktyget på Windows.
...
**Installation:** Bygg enligt kommentarer i filen make.bat eller make.sh. Eller se om det finns en färdig
